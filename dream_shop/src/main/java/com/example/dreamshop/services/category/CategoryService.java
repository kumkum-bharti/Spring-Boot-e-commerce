...
public Category addCategory(Category category) {
    ...
    }//no need to write categoryRepository before getting as it is inbuilt method of it only
    ...
    }//simply findById as we dont have to do something with it only delete
}
